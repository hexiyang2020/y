              ...
              <div class="card" style="margin-top: 20px;">
                  <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-4">
                          <div class="col-item">
                            <div class="col-item-name">关注数</div>
                            <div class="col-item-num">123</div>
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="col-item">
                            <div class="col-item-name">粉丝数</div>
                            <div class="col-item-num">231</div>
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="col-item">
                            <div class="col-item-name">发帖数</div>
                            <div class="col-item-num">0</div>
                          </div>
                        </div>
                      </div>
                  </div>
          ...
          <div class="col-9">
              <div class="card" style="margin-top: 20px;">
                  <div class="card-header">
                      <span style="font-size: 150%;float: left;">我的订单</span>
                      ...
                      <div class="modal fade" id="add-bot-btn" tabindex="-1">
                          <div class="modal-dialog modal-xl">
                              ...
                              <div class="modal-header">
                                  <h1 class="modal-title fs-5">创建订单</h1>
                                  ...
                                  <td>
                                      ...
                                      <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                          <div class="modal-dialog modal-xl">
                                              <div class="modal-content">
                                              <div class="modal-header">
                                                  <h1 class="modal-title fs-5">修改订单</h1>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                              </div>
                                              <div class="modal-body">
                                                  <div class="mb-3">
